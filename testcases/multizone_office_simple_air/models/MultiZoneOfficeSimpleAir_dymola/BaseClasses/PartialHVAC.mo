...
partial model PartialHVAC
  ...
  parameter Real ratVFloHea(unit="1")=0.3
  ...
  Modelica.Blocks.Interfaces.RealInput TRoo[numZon](
   each final unit="K",
   each displayUnit="degC") "Room temperatures"
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox cor(
    ...
    mCooAir_flow_nominal=5,
    mHeaAir_flow_nominal=5,
    THeaWatInl_nominal(displayUnit="K") = 318.15,
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
    mCooAir_flow_nominal=1,
    mHeaAir_flow_nominal=1,
    THeaWatInl_nominal(displayUnit="K") = 318.15,
    THeaAirDis_nominal=305.15,
    VRoo=VRooSou,
    allowFlowReversal=allowFlowReversal,
  ...
  Buildings.Examples.VAVReheat.BaseClasses.VAVReheatBox eas(
    ...
    mCooAir_flow_nominal=1,
    mHeaAir_flow_nominal=1,
    THeaWatInl_nominal(displayUnit="degC") = 318.15,
    THeaAirDis_nominal=305.15,
    VRoo=VRooEas,
    allowFlowReversal=allowFlowReversal,
    THeaWatOut_nominal=THotWatInl_nominal-10,
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage valCooCoi(
    ...
    dpFixed_nominal=35000)
                       "Valve for cooling coil" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={220,-210})));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage valHeaCoi(
    ...
    dpValve_nominal=6000,
    dpFixed_nominal=35000)
                       "Valve for heating coil" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={128,-210})));
