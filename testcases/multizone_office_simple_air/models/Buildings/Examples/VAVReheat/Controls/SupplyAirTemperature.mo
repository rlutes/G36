...
block SupplyAirTemperature
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TSupSet_out(final unit="K")
    "Supply air temperature setpoint" annotation (Placement(transformation(
          extent={{120,-60},{160,-20}}), iconTransformation(extent={{100,-50},{
            140,-10}})));
equation
  ...
  connect(uEna, con.trigger) annotation (Line(points={{-160,-100},{-106,-100},{-106,
          -12}}, color={255,0,255}));
  connect(TSupSet, TSupSet_out)
    annotation (Line(points={{-160,-40},{140,-40}}, color={0,0,127}));
  annotation (
