...
model HVACFilter
  "HVAC filter with constant efficiency and fixed flow resistance with dp and m_flow as parameter"
  extends MultiZoneOfficeSimpleAir.BaseClasses.PartialHVACFilter(
