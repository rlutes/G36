...
model WriteAhu "Collection of AHU overwrite points for BOPTEST"
  ...
  Buildings.Utilities.IO.SignalExchange.Overwrite yPumCoo(description=
        "Cooling coil pump control signal for AHU", u(
      unit="1",
      min=0,
  ...
  Modelica.Blocks.Interfaces.RealInput yPumCoo_in
    "Cooling coil pump control signal"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  Modelica.Blocks.Interfaces.RealOutput yPumHea_out
    "Heating coil pump control signal"
...
equation
  ...
  connect(yFan_in,yFan. u) annotation (Line(
      points={{-120,160},{-2,160}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(yHea_in,yHea. u) annotation (Line(
      points={{-120,120},{-61,120},{-2,120}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  ...
  connect(yRet_in,yRet. u) annotation (Line(points={{-120,-160},{-2,-160}},
                            color={0,0,127}));
  connect(yPumHea_in, yPumHea.u) annotation (Line(
      points={{-120,40},{-61,40},{-2,40}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(yPumCoo_in, yPumCoo.u) annotation (Line(
      points={{-120,0},{-61,0},{-2,0}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(yPumHea.y, yPumHea_out) annotation (Line(
      points={{21,40},{110,40}},
      color={0,0,127},
      smooth=Smooth.Bezier));
  connect(yPumCoo.y, yPumCoo_out) annotation (Line(
      points={{21,0},{110,0}},
      color={0,0,127},
      smooth=Smooth.Bezier));
