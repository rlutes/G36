model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonCor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonCor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonCor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonCor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonEas_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonEas_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonEas_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonEas_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonNor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonNor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonNor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonNor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonSou_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonSou_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonSou_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonSou_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonWes_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonWes_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealInput hvac_floor1_oveZonWes_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor1_oveZonWes_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone wes";
	...
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonCor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonCor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonCor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonCor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonEas_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonEas_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonEas_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonEas_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonNor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonNor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonNor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonNor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonSou_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonSou_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonSou_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonSou_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonWes_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonWes_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealInput hvac_floor2_oveZonWes_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor2_oveZonWes_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone wes";
	...
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonCor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonCor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonCor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonCor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonEas_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonEas_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonEas_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonEas_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonNor_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonNor_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonNor_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonNor_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonSou_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonSou_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonSou_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonSou_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonWes_TZonCooSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonWes_TZonCooSet_activate "Activation for Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealInput hvac_floor3_oveZonWes_TZonHeaSet_u(unit="K", min=285.15, max=313.15) "Zone air temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.BooleanInput hvac_floor3_oveZonWes_TZonHeaSet_activate "Activation for Zone air temperature heating setpoint for zone wes";
	...
	// Out read
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor1.reaZonCor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonecor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor1.reaZonCor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_TSup_y(unit="K") = mod.hvac.floor1.reaZonCor.TSup.y "Discharge air temperature to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_TZon_y(unit="K") = mod.hvac.floor1.reaZonCor.TZon.y "Zone air temperature measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_V_flow_y(unit="m3/s") = mod.hvac.floor1.reaZonCor.V_flow.y "Discharge air flowrate to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_V_flow_set_y(unit="m3/s") = mod.hvac.floor1.reaZonCor.V_flow_set.y "Airflow setpointcor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_yCoo_y(unit="1") = mod.hvac.floor1.reaZonCor.yCoo.y "Cooling PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_yDam_y(unit="1") = mod.hvac.floor1.reaZonCor.yDam.y "Damper position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_yHea_y(unit="1") = mod.hvac.floor1.reaZonCor.yHea.y "Heating PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonCor_yReheaVal_y(unit="1") = mod.hvac.floor1.reaZonCor.yReheaVal.y "Reheat valve position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_TRoo_Coo_set_y(unit="K") = mod.hvac.floor1.reaZonEas.TRoo_Coo_set.y "Zone temperature cooling setpoint for zoneeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_TRoo_Hea_set_y(unit="K") = mod.hvac.floor1.reaZonEas.TRoo_Hea_set.y "Zone temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_TSup_y(unit="K") = mod.hvac.floor1.reaZonEas.TSup.y "Discharge air temperature to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_TZon_y(unit="K") = mod.hvac.floor1.reaZonEas.TZon.y "Zone air temperature measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_V_flow_y(unit="m3/s") = mod.hvac.floor1.reaZonEas.V_flow.y "Discharge air flowrate to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_V_flow_set_y(unit="m3/s") = mod.hvac.floor1.reaZonEas.V_flow_set.y "Airflow setpointeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_yCoo_y(unit="1") = mod.hvac.floor1.reaZonEas.yCoo.y "Cooling PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_yDam_y(unit="1") = mod.hvac.floor1.reaZonEas.yDam.y "Damper position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_yHea_y(unit="1") = mod.hvac.floor1.reaZonEas.yHea.y "Heating PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonEas_yReheaVal_y(unit="1") = mod.hvac.floor1.reaZonEas.yReheaVal.y "Reheat valve position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor1.reaZonNor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonenor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor1.reaZonNor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_TSup_y(unit="K") = mod.hvac.floor1.reaZonNor.TSup.y "Discharge air temperature to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_TZon_y(unit="K") = mod.hvac.floor1.reaZonNor.TZon.y "Zone air temperature measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_V_flow_y(unit="m3/s") = mod.hvac.floor1.reaZonNor.V_flow.y "Discharge air flowrate to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_V_flow_set_y(unit="m3/s") = mod.hvac.floor1.reaZonNor.V_flow_set.y "Airflow setpointnor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_yCoo_y(unit="1") = mod.hvac.floor1.reaZonNor.yCoo.y "Cooling PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_yDam_y(unit="1") = mod.hvac.floor1.reaZonNor.yDam.y "Damper position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_yHea_y(unit="1") = mod.hvac.floor1.reaZonNor.yHea.y "Heating PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonNor_yReheaVal_y(unit="1") = mod.hvac.floor1.reaZonNor.yReheaVal.y "Reheat valve position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_TRoo_Coo_set_y(unit="K") = mod.hvac.floor1.reaZonSou.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonesou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_TRoo_Hea_set_y(unit="K") = mod.hvac.floor1.reaZonSou.TRoo_Hea_set.y "Zone temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_TSup_y(unit="K") = mod.hvac.floor1.reaZonSou.TSup.y "Discharge air temperature to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_TZon_y(unit="K") = mod.hvac.floor1.reaZonSou.TZon.y "Zone air temperature measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_V_flow_y(unit="m3/s") = mod.hvac.floor1.reaZonSou.V_flow.y "Discharge air flowrate to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_V_flow_set_y(unit="m3/s") = mod.hvac.floor1.reaZonSou.V_flow_set.y "Airflow setpointsou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_yCoo_y(unit="1") = mod.hvac.floor1.reaZonSou.yCoo.y "Cooling PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_yDam_y(unit="1") = mod.hvac.floor1.reaZonSou.yDam.y "Damper position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_yHea_y(unit="1") = mod.hvac.floor1.reaZonSou.yHea.y "Heating PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonSou_yReheaVal_y(unit="1") = mod.hvac.floor1.reaZonSou.yReheaVal.y "Reheat valve position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_TRoo_Coo_set_y(unit="K") = mod.hvac.floor1.reaZonWes.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonewes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_TRoo_Hea_set_y(unit="K") = mod.hvac.floor1.reaZonWes.TRoo_Hea_set.y "Zone temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_TSup_y(unit="K") = mod.hvac.floor1.reaZonWes.TSup.y "Discharge air temperature to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_TZon_y(unit="K") = mod.hvac.floor1.reaZonWes.TZon.y "Zone air temperature measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_V_flow_y(unit="m3/s") = mod.hvac.floor1.reaZonWes.V_flow.y "Discharge air flowrate to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_V_flow_set_y(unit="m3/s") = mod.hvac.floor1.reaZonWes.V_flow_set.y "Airflow setpointwes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_yCoo_y(unit="1") = mod.hvac.floor1.reaZonWes.yCoo.y "Cooling PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_yDam_y(unit="1") = mod.hvac.floor1.reaZonWes.yDam.y "Damper position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_yHea_y(unit="1") = mod.hvac.floor1.reaZonWes.yHea.y "Heating PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_reaZonWes_yReheaVal_y(unit="1") = mod.hvac.floor1.reaZonWes.yReheaVal.y "Reheat valve position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_readAhu_PFanSup_y(unit="W") = mod.hvac.floor1.readAhu.PFanSup.y "Electrical power measurement of supply fan for AHU";
	...
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor2.reaZonCor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonecor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor2.reaZonCor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_TSup_y(unit="K") = mod.hvac.floor2.reaZonCor.TSup.y "Discharge air temperature to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_TZon_y(unit="K") = mod.hvac.floor2.reaZonCor.TZon.y "Zone air temperature measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_V_flow_y(unit="m3/s") = mod.hvac.floor2.reaZonCor.V_flow.y "Discharge air flowrate to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_V_flow_set_y(unit="m3/s") = mod.hvac.floor2.reaZonCor.V_flow_set.y "Airflow setpointcor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_yCoo_y(unit="1") = mod.hvac.floor2.reaZonCor.yCoo.y "Cooling PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_yDam_y(unit="1") = mod.hvac.floor2.reaZonCor.yDam.y "Damper position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_yHea_y(unit="1") = mod.hvac.floor2.reaZonCor.yHea.y "Heating PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonCor_yReheaVal_y(unit="1") = mod.hvac.floor2.reaZonCor.yReheaVal.y "Reheat valve position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_TRoo_Coo_set_y(unit="K") = mod.hvac.floor2.reaZonEas.TRoo_Coo_set.y "Zone temperature cooling setpoint for zoneeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_TRoo_Hea_set_y(unit="K") = mod.hvac.floor2.reaZonEas.TRoo_Hea_set.y "Zone temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_TSup_y(unit="K") = mod.hvac.floor2.reaZonEas.TSup.y "Discharge air temperature to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_TZon_y(unit="K") = mod.hvac.floor2.reaZonEas.TZon.y "Zone air temperature measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_V_flow_y(unit="m3/s") = mod.hvac.floor2.reaZonEas.V_flow.y "Discharge air flowrate to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_V_flow_set_y(unit="m3/s") = mod.hvac.floor2.reaZonEas.V_flow_set.y "Airflow setpointeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_yCoo_y(unit="1") = mod.hvac.floor2.reaZonEas.yCoo.y "Cooling PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_yDam_y(unit="1") = mod.hvac.floor2.reaZonEas.yDam.y "Damper position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_yHea_y(unit="1") = mod.hvac.floor2.reaZonEas.yHea.y "Heating PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonEas_yReheaVal_y(unit="1") = mod.hvac.floor2.reaZonEas.yReheaVal.y "Reheat valve position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor2.reaZonNor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonenor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor2.reaZonNor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_TSup_y(unit="K") = mod.hvac.floor2.reaZonNor.TSup.y "Discharge air temperature to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_TZon_y(unit="K") = mod.hvac.floor2.reaZonNor.TZon.y "Zone air temperature measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_V_flow_y(unit="m3/s") = mod.hvac.floor2.reaZonNor.V_flow.y "Discharge air flowrate to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_V_flow_set_y(unit="m3/s") = mod.hvac.floor2.reaZonNor.V_flow_set.y "Airflow setpointnor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_yCoo_y(unit="1") = mod.hvac.floor2.reaZonNor.yCoo.y "Cooling PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_yDam_y(unit="1") = mod.hvac.floor2.reaZonNor.yDam.y "Damper position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_yHea_y(unit="1") = mod.hvac.floor2.reaZonNor.yHea.y "Heating PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonNor_yReheaVal_y(unit="1") = mod.hvac.floor2.reaZonNor.yReheaVal.y "Reheat valve position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_TRoo_Coo_set_y(unit="K") = mod.hvac.floor2.reaZonSou.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonesou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_TRoo_Hea_set_y(unit="K") = mod.hvac.floor2.reaZonSou.TRoo_Hea_set.y "Zone temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_TSup_y(unit="K") = mod.hvac.floor2.reaZonSou.TSup.y "Discharge air temperature to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_TZon_y(unit="K") = mod.hvac.floor2.reaZonSou.TZon.y "Zone air temperature measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_V_flow_y(unit="m3/s") = mod.hvac.floor2.reaZonSou.V_flow.y "Discharge air flowrate to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_V_flow_set_y(unit="m3/s") = mod.hvac.floor2.reaZonSou.V_flow_set.y "Airflow setpointsou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_yCoo_y(unit="1") = mod.hvac.floor2.reaZonSou.yCoo.y "Cooling PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_yDam_y(unit="1") = mod.hvac.floor2.reaZonSou.yDam.y "Damper position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_yHea_y(unit="1") = mod.hvac.floor2.reaZonSou.yHea.y "Heating PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonSou_yReheaVal_y(unit="1") = mod.hvac.floor2.reaZonSou.yReheaVal.y "Reheat valve position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_TRoo_Coo_set_y(unit="K") = mod.hvac.floor2.reaZonWes.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonewes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_TRoo_Hea_set_y(unit="K") = mod.hvac.floor2.reaZonWes.TRoo_Hea_set.y "Zone temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_TSup_y(unit="K") = mod.hvac.floor2.reaZonWes.TSup.y "Discharge air temperature to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_TZon_y(unit="K") = mod.hvac.floor2.reaZonWes.TZon.y "Zone air temperature measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_V_flow_y(unit="m3/s") = mod.hvac.floor2.reaZonWes.V_flow.y "Discharge air flowrate to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_V_flow_set_y(unit="m3/s") = mod.hvac.floor2.reaZonWes.V_flow_set.y "Airflow setpointwes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_yCoo_y(unit="1") = mod.hvac.floor2.reaZonWes.yCoo.y "Cooling PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_yDam_y(unit="1") = mod.hvac.floor2.reaZonWes.yDam.y "Damper position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_yHea_y(unit="1") = mod.hvac.floor2.reaZonWes.yHea.y "Heating PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_reaZonWes_yReheaVal_y(unit="1") = mod.hvac.floor2.reaZonWes.yReheaVal.y "Reheat valve position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_readAhu_PFanSup_y(unit="W") = mod.hvac.floor2.readAhu.PFanSup.y "Electrical power measurement of supply fan for AHU";
	...
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor3.reaZonCor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonecor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor3.reaZonCor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_TSup_y(unit="K") = mod.hvac.floor3.reaZonCor.TSup.y "Discharge air temperature to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_TZon_y(unit="K") = mod.hvac.floor3.reaZonCor.TZon.y "Zone air temperature measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_V_flow_y(unit="m3/s") = mod.hvac.floor3.reaZonCor.V_flow.y "Discharge air flowrate to zone measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_V_flow_set_y(unit="m3/s") = mod.hvac.floor3.reaZonCor.V_flow_set.y "Airflow setpointcor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_yCoo_y(unit="1") = mod.hvac.floor3.reaZonCor.yCoo.y "Cooling PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_yDam_y(unit="1") = mod.hvac.floor3.reaZonCor.yDam.y "Damper position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_yHea_y(unit="1") = mod.hvac.floor3.reaZonCor.yHea.y "Heating PID signal measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonCor_yReheaVal_y(unit="1") = mod.hvac.floor3.reaZonCor.yReheaVal.y "Reheat valve position measurement for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_TRoo_Coo_set_y(unit="K") = mod.hvac.floor3.reaZonEas.TRoo_Coo_set.y "Zone temperature cooling setpoint for zoneeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_TRoo_Hea_set_y(unit="K") = mod.hvac.floor3.reaZonEas.TRoo_Hea_set.y "Zone temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_TSup_y(unit="K") = mod.hvac.floor3.reaZonEas.TSup.y "Discharge air temperature to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_TZon_y(unit="K") = mod.hvac.floor3.reaZonEas.TZon.y "Zone air temperature measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_V_flow_y(unit="m3/s") = mod.hvac.floor3.reaZonEas.V_flow.y "Discharge air flowrate to zone measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_V_flow_set_y(unit="m3/s") = mod.hvac.floor3.reaZonEas.V_flow_set.y "Airflow setpointeas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_yCoo_y(unit="1") = mod.hvac.floor3.reaZonEas.yCoo.y "Cooling PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_yDam_y(unit="1") = mod.hvac.floor3.reaZonEas.yDam.y "Damper position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_yHea_y(unit="1") = mod.hvac.floor3.reaZonEas.yHea.y "Heating PID signal measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonEas_yReheaVal_y(unit="1") = mod.hvac.floor3.reaZonEas.yReheaVal.y "Reheat valve position measurement for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_TRoo_Coo_set_y(unit="K") = mod.hvac.floor3.reaZonNor.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonenor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_TRoo_Hea_set_y(unit="K") = mod.hvac.floor3.reaZonNor.TRoo_Hea_set.y "Zone temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_TSup_y(unit="K") = mod.hvac.floor3.reaZonNor.TSup.y "Discharge air temperature to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_TZon_y(unit="K") = mod.hvac.floor3.reaZonNor.TZon.y "Zone air temperature measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_V_flow_y(unit="m3/s") = mod.hvac.floor3.reaZonNor.V_flow.y "Discharge air flowrate to zone measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_V_flow_set_y(unit="m3/s") = mod.hvac.floor3.reaZonNor.V_flow_set.y "Airflow setpointnor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_yCoo_y(unit="1") = mod.hvac.floor3.reaZonNor.yCoo.y "Cooling PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_yDam_y(unit="1") = mod.hvac.floor3.reaZonNor.yDam.y "Damper position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_yHea_y(unit="1") = mod.hvac.floor3.reaZonNor.yHea.y "Heating PID signal measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonNor_yReheaVal_y(unit="1") = mod.hvac.floor3.reaZonNor.yReheaVal.y "Reheat valve position measurement for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_TRoo_Coo_set_y(unit="K") = mod.hvac.floor3.reaZonSou.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonesou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_TRoo_Hea_set_y(unit="K") = mod.hvac.floor3.reaZonSou.TRoo_Hea_set.y "Zone temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_TSup_y(unit="K") = mod.hvac.floor3.reaZonSou.TSup.y "Discharge air temperature to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_TZon_y(unit="K") = mod.hvac.floor3.reaZonSou.TZon.y "Zone air temperature measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_V_flow_y(unit="m3/s") = mod.hvac.floor3.reaZonSou.V_flow.y "Discharge air flowrate to zone measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_V_flow_set_y(unit="m3/s") = mod.hvac.floor3.reaZonSou.V_flow_set.y "Airflow setpointsou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_yCoo_y(unit="1") = mod.hvac.floor3.reaZonSou.yCoo.y "Cooling PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_yDam_y(unit="1") = mod.hvac.floor3.reaZonSou.yDam.y "Damper position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_yHea_y(unit="1") = mod.hvac.floor3.reaZonSou.yHea.y "Heating PID signal measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonSou_yReheaVal_y(unit="1") = mod.hvac.floor3.reaZonSou.yReheaVal.y "Reheat valve position measurement for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_TRoo_Coo_set_y(unit="K") = mod.hvac.floor3.reaZonWes.TRoo_Coo_set.y "Zone temperature cooling setpoint for zonewes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_TRoo_Hea_set_y(unit="K") = mod.hvac.floor3.reaZonWes.TRoo_Hea_set.y "Zone temperature heating setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_TSup_y(unit="K") = mod.hvac.floor3.reaZonWes.TSup.y "Discharge air temperature to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_TZon_y(unit="K") = mod.hvac.floor3.reaZonWes.TZon.y "Zone air temperature measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_V_flow_y(unit="m3/s") = mod.hvac.floor3.reaZonWes.V_flow.y "Discharge air flowrate to zone measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_V_flow_set_y(unit="m3/s") = mod.hvac.floor3.reaZonWes.V_flow_set.y "Airflow setpointwes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_yCoo_y(unit="1") = mod.hvac.floor3.reaZonWes.yCoo.y "Cooling PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_yDam_y(unit="1") = mod.hvac.floor3.reaZonWes.yDam.y "Damper position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_yHea_y(unit="1") = mod.hvac.floor3.reaZonWes.yHea.y "Heating PID signal measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_reaZonWes_yReheaVal_y(unit="1") = mod.hvac.floor3.reaZonWes.yReheaVal.y "Reheat valve position measurement for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_readAhu_PFanSup_y(unit="W") = mod.hvac.floor3.readAhu.PFanSup.y "Electrical power measurement of supply fan for AHU";
	...
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonCor_TZonCooSet_y(unit="K") = mod.hvac.floor1.oveZonCor.TZonCooSet.y "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonCor_TZonHeaSet_y(unit="K") = mod.hvac.floor1.oveZonCor.TZonHeaSet.y "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonEas_TZonCooSet_y(unit="K") = mod.hvac.floor1.oveZonEas.TZonCooSet.y "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonEas_TZonHeaSet_y(unit="K") = mod.hvac.floor1.oveZonEas.TZonHeaSet.y "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonNor_TZonCooSet_y(unit="K") = mod.hvac.floor1.oveZonNor.TZonCooSet.y "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonNor_TZonHeaSet_y(unit="K") = mod.hvac.floor1.oveZonNor.TZonHeaSet.y "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonSou_TZonCooSet_y(unit="K") = mod.hvac.floor1.oveZonSou.TZonCooSet.y "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonSou_TZonHeaSet_y(unit="K") = mod.hvac.floor1.oveZonSou.TZonHeaSet.y "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonWes_TZonCooSet_y(unit="K") = mod.hvac.floor1.oveZonWes.TZonCooSet.y "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor1_oveZonWes_TZonHeaSet_y(unit="K") = mod.hvac.floor1.oveZonWes.TZonHeaSet.y "Zone air temperature heating setpoint for zone wes";
	...
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonCor_TZonCooSet_y(unit="K") = mod.hvac.floor2.oveZonCor.TZonCooSet.y "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonCor_TZonHeaSet_y(unit="K") = mod.hvac.floor2.oveZonCor.TZonHeaSet.y "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonEas_TZonCooSet_y(unit="K") = mod.hvac.floor2.oveZonEas.TZonCooSet.y "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonEas_TZonHeaSet_y(unit="K") = mod.hvac.floor2.oveZonEas.TZonHeaSet.y "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonNor_TZonCooSet_y(unit="K") = mod.hvac.floor2.oveZonNor.TZonCooSet.y "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonNor_TZonHeaSet_y(unit="K") = mod.hvac.floor2.oveZonNor.TZonHeaSet.y "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonSou_TZonCooSet_y(unit="K") = mod.hvac.floor2.oveZonSou.TZonCooSet.y "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonSou_TZonHeaSet_y(unit="K") = mod.hvac.floor2.oveZonSou.TZonHeaSet.y "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonWes_TZonCooSet_y(unit="K") = mod.hvac.floor2.oveZonWes.TZonCooSet.y "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor2_oveZonWes_TZonHeaSet_y(unit="K") = mod.hvac.floor2.oveZonWes.TZonHeaSet.y "Zone air temperature heating setpoint for zone wes";
	...
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonCor_TZonCooSet_y(unit="K") = mod.hvac.floor3.oveZonCor.TZonCooSet.y "Zone air temperature cooling setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonCor_TZonHeaSet_y(unit="K") = mod.hvac.floor3.oveZonCor.TZonHeaSet.y "Zone air temperature heating setpoint for zone cor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonEas_TZonCooSet_y(unit="K") = mod.hvac.floor3.oveZonEas.TZonCooSet.y "Zone air temperature cooling setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonEas_TZonHeaSet_y(unit="K") = mod.hvac.floor3.oveZonEas.TZonHeaSet.y "Zone air temperature heating setpoint for zone eas";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonNor_TZonCooSet_y(unit="K") = mod.hvac.floor3.oveZonNor.TZonCooSet.y "Zone air temperature cooling setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonNor_TZonHeaSet_y(unit="K") = mod.hvac.floor3.oveZonNor.TZonHeaSet.y "Zone air temperature heating setpoint for zone nor";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonSou_TZonCooSet_y(unit="K") = mod.hvac.floor3.oveZonSou.TZonCooSet.y "Zone air temperature cooling setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonSou_TZonHeaSet_y(unit="K") = mod.hvac.floor3.oveZonSou.TZonHeaSet.y "Zone air temperature heating setpoint for zone sou";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonWes_TZonCooSet_y(unit="K") = mod.hvac.floor3.oveZonWes.TZonCooSet.y "Zone air temperature cooling setpoint for zone wes";
	Modelica.Blocks.Interfaces.RealOutput hvac_floor3_oveZonWes_TZonHeaSet_y(unit="K") = mod.hvac.floor3.oveZonWes.TZonHeaSet.y "Zone air temperature heating setpoint for zone wes";
